...
**Status:** Superseded by Stage 27. The previous evidence must not be treated
as valid for aggregated Pod sizing.
...
**Prerequisites:** ADR-011 is Accepted by the repository owner.
